...
const Navbar = ({ locale }: NavbarProps) => {
  ...
  return (
    <nav className="fixed z-10 top-6 inset-x-4 h-16 xs:h-18 bg-foreground/5 backdrop-blur-lg shadow-soft max-w-(--breakpoint-xl) mx-auto rounded-full">
      <div className="h-full flex items-center justify-between mx-auto px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            >
              {t.navbar.chatButton} {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
