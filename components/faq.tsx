  ...
  return (
    ...
    >
      <div className="max-w-(--breakpoint-lg)">
        ...
        <div className="mt-12 grid md:grid-cols-2 bg-background rounded-xl overflow-hidden card-border-warm">
          {faq.map(({ question, answer, icon: Icon }) => (
            <div key={question} className="border-coral/10 border-l-2 p-6 -mt-px -ml-px hover:border-coral/20 transition-colors duration-300">
